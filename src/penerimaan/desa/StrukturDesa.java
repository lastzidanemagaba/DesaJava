 ...
 * @author Imul
 */
public class StrukturDesa extends javax.swing.JFrame {
    
    private int role;

    /**
     * Creates new form StrukturDesa
     */
    public StrukturDesa() {
        initComponents();
    }
    
    public StrukturDesa(int role) {
        initComponents();
        this.role = role;
        if (role > 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StrukturDesa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StrukturDesa().setVisible(true);
            }
        });
    }
